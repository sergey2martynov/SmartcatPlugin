...
try {
    ...
    & $mkcert -install
    & $mkcert "*.smartcatplugin.localhost"
}
catch {
...
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.smartcatplugin.localhost"
}
Add-HostsEntry "cm.smartcatplugin.localhost"
Add-HostsEntry "id.smartcatplugin.localhost"
Add-HostsEntry "www.smartcatplugin.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.smartcatplugin.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.smartcatplugin.localhost"
    }


    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.smartcatplugin.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.smartcatplugin.localhost"
