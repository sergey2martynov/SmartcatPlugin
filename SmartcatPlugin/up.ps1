...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.smartcatplugin.localhost/ --auth https://id.smartcatplugin.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.smartcatplugin.localhost/ --auth https://id.smartcatplugin.localhost/ --allow-write true
}
...
Start-Process https://cm.smartcatplugin.localhost/sitecore/
Start-Process https://www.smartcatplugin.localhost/
